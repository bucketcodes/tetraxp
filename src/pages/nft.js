          ...
          {links.map((link) => (
            ...
            >
              <ReactSVG
                ...
                type="image/svg+xml"
                alt={link.label}
                className="fill-neutral-600 hover:fill-white transition-colors duration-300 mr-4 last:mr-0 w-16 h-7"
              />
            </a>
          ))}
        </div>
...
export const Head = () => (
  <>
    <title>TETRA ➕ - NFT Collections</title>
    <meta name="description" content="A plethora of NFT Collections created and minted on independent contracts from 2021 to 2023, sold on the Ethereum and Tezos blockchain." />
    <meta name="keywords" content="TETRA, nft, mint, art" />
