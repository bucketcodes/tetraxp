    ...
    <div className="items-center">
      <div className="flex justify-center">
        ...
        >
          <ReactSVG
            ...
            type="image/svg+xml"
            alt="Foundation"
            className="fill-neutral-500 hover:fill-white transition-colors duration-300 lg:w-32 lg:h-32 md:w-24 md:h-24 sm:w-20 sm:h-20 w-20 h-20 mr-4"
          />
        </a>
        <a
        ...
        >
          <ReactSVG
            ...
            type="image/svg+xml"
            alt="Tezos"
            className="fill-neutral-500 hover:fill-white transition-colors duration-300 lg:w-32 lg:h-32 md:w-24 md:h-24 sm:w-20 sm:h-20 w-20 h-20"
          />
        </a>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-125 duration-300 h-auto max-w-full rounded-lg mx-auto"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-125 duration-300 h-auto max-w-full rounded-lg ml-auto"
        >
...
export const Head = () => <title>NFTs</title>;
