    ...
    <Fragment>
      <div className="w-full sm:max-w-sm max-w-sm p-2 rounded-lg shadow-lg bg-neutral-900">
        ...
        <p className="text-gray-600 text-xs">
          ...
          others. They have a talent for finding solutions to complex problems,
          whether they relate to art, technology, or people. They have a vision
          of making the world a better place through their work, and they are
          always ready to take on new challenges and opportunities that will
        ...
        <Timeline>
          <TimelineItem>
            ...
            <TimelineHeader className="h-3">
              ...
              <Typography
                variant="h6"
                className="leading-none text-neutral-700"
              >
                ORIGIN ERA
              </Typography>
            </TimelineHeader>
          ...
          <TimelineItem>
            ...
            <TimelineBody className="pb-2">
              <Typography variant="small" className="text-xs text-gray-600">
                Presence, creation for others, a measure of skill, a learning
                period. Growing into becoming a creator, planting the seeds.
              </Typography>
            </TimelineBody>
          </TimelineItem>
          <TimelineItem>
            ...
            <TimelineBody className="pb-2">
              <Typography variant="small" className="text-xs text-gray-600">
                World-building, generation of income through vision, convergence
                of harsh realities, where a hobby became an escape. A shift in
                perception.
              </Typography>
            </TimelineBody>
          </TimelineItem>
          <TimelineItem>
            ...
            <TimelineBody>
              <Typography variant="small" className="text-xs text-gray-600">
                Ultimate fruition, hyper self-awareness and realizations. The
                journey has become lonely, but dreams have never been closer
                within reach. A true prime, this is for life.
              </Typography>
            </TimelineBody>
          </TimelineItem>
        </Timeline>
