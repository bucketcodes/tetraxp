    ...
    <Fragment>
      ...
      <div className="grid">
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <hr className="w-full h-px mx-auto border-0 rounded mt-2 mb-4 bg-neutral-800"></hr>
          <p className="text-neutral-400 text-sm mb-6">
            My art is a tribute to those who never had the chance to create, who
            always felt their dreams were out of reach. Through my art, I
            express myself, my vision, my thoughts with the world, hoping to
            inspire and resonate with others. I create to connect, with myself
            and with those who share my passion and struggles, who never felt
            they belonged or understood. My future is bigger than me, it always
            has been. I have a mission, a purpose, a calling to create.
          </p>
          <p className="text-neutral-400 text-sm mb-6">
            This is for those who saw the potential in me when I was blind to
            it, and for those who supported me through the hard times and
            celebrated with me through the good times, thank you. You are the
            reason I am here today, and I will always be grateful for your love
            and faith in me.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="grid">
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <hr className="w-full h-px mx-auto border-0 rounded mt-2 mb-4 bg-neutral-800"></hr>
          <p className="text-neutral-400 text-sm mb-6">
            This website is the work of Tetra, with the help of Tim (Bucket
            Codes) creating the blueprint, utilizing Gatsby, React JS, and
            Tailwind CSS for creation.{" "}
            <b>
        ...
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          <a className="mt-2 text-3xl font-bold text-neutral-300">
            TIMELINE (AGE, ERA)
          </a>
          <hr className="w-full h-px mx-auto border-0 rounded mt-2 mb-4 bg-neutral-800"></hr>
          <Timeline>
            <TimelineItem>
              ...
              <TimelineBody className="pb-2">
                <Typography className="my-2 text-sm text-neutral-400">
                  ...
                  creation, the roots of fervor. Historical snapshots, the
                  nascent web.
                </Typography>
              </TimelineBody>
            </TimelineItem>
            <TimelineItem>
              ...
              <TimelineBody className="pb-2">
                <Typography className="my-2 text-sm text-neutral-400">
                  Existence, artistry for the world, a test of talent, a phase
                  of learning. Blossoming into a maker, sowing the seeds.
                </Typography>
              </TimelineBody>
            </TimelineItem>
            <TimelineItem>
            ...
            <TimelineItem>
              ...
              <TimelineBody>
                <Typography className="my-2 text-sm text-neutral-400">
                  Final achievement, intense self-consciousness and insights.
                  The voyage has grown solitary, but visions have never been
                  nearer to grasp. A genuine peak, this is for eternity.
                </Typography>
              </TimelineBody>
            </TimelineItem>
          </Timeline>
