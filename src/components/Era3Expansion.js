    ...
    <Fragment>
      <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
        ...
        <p className="text-neutral-400 text-sm mb-6">
          I overcame many obstacles and hardships in my life. It was a period of
          transition, discovery, and personal development. I witnessed many
          friends come and go, family moving on, and the shifting of values in
          the world. But I also discovered a passion and a purpose in creating.
        </p>
        <p className="text-neutral-400 text-sm mb-6">
          Creating was my sanctuary and my expression. I decided to quit my role
          as Server Owner at Cloudcrux, and explore new avenues and
          possibilities. I devoted myself to music, art, photography, and video
          making, honing my skills and talents like never before.
        </p>
        ...
        <p className="text-neutral-400 text-sm mb-6">
          ...
          myself, and upgraded my equipment with my own money.
        </p>
        <p className="text-neutral-400 text-sm mb-6">
          LA was an amazing trip that taught me how to depend on myself and
          collaborate with other talented music artists. We had a blast, just
          vibing, living, and creating. I was creating a catalyst.
        </p>
      </div>
      <div className="grid">
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <hr className="w-full h-px mx-auto border-0 rounded mt-2 mb-4 bg-neutral-800"></hr>
          <p className="text-neutral-400 text-sm mb-6">
            Ah! Hermes was created in 2012, but 2019 was when we turned it into
            a collective of local and international music artists and producers.
            We were a versatile group with different skills and talents. I was
            an engineer, videographer, and a facilitator who helped some members
            record and produce their music.
          </p>
          <p className="text-neutral-400 text-sm mb-6">
            My room became Tetra HQ, where we had meetings to inspire and
            support each other creatively. We also partnered with Audius to
            participate in virtual concerts and other platform features. It felt
            like we were exploring a new frontier after Soundcloud.
          </p>
        </div>
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          <div className="relative">
        ...
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          <p className="text-neutral-400 text-sm mb-6">
            In late 2019, I stepped on the stage for the first time in my life.
            It was one of the most exhilarating and unforgettable experiences I
            ever had. The event was a small one, organized by a friend of a
            friend. I was there as a photographer, capturing the moments of the
            other performers. But I also had a chance to showcase my own talent.
            I performed a feature that I had written and rehearsed. It was my
            only set, but I’m glad I did it. I felt a rush of adrenaline and joy
            as I shared my words with the audience.
          </p>
          <div className="relative">
            <img
              className="object-cover w-full h-full rounded-lg transition-opacity duration-500"
      ...
      <div className="grid">
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <hr className="w-full h-px mx-auto border-0 rounded mt-2 mb-4 bg-neutral-800"></hr>
          <p className="text-neutral-400 text-sm mb-6">
            Young Adult is the result of a collaboration between Yeeevs and me,
            dating back to 2018. We remastered it for Audius in 2019, showcasing
            our best skills and talents. This project reflects our years of hard
            work and dedication in rapping and engineering. The cover art is
            from the same day I snapped the selfie below.
          </p>
          <p className="text-neutral-400 text-sm mb-6">
            Aside from engineering this project, I am also featured on two
            tracks, Medievil which was produced by MXXXY, and Run It Up!
            produced by the legend, Whiskey Ramone.
          </p>
        </div>
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          <div className="relative">
          ...
          <p className="text-neutral-400 text-sm mb-6">
            ...
            launch of Stay Sunny by Holland Izz, had a successful launch party
            for that as well. We founded Timeless in that same summer. When I
            came back to New York, we transformed Ah! Hermes into a formidable
            musical collective. It was a splendid culmination of what we had
            cultivated in the previous years.
          </p>
        </div>
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          <div className="relative">
      ...
      <div className="grid">
        ...
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <p className="text-neutral-400 text-sm mb-6">
            ...
            various clients while also exploring other artistic mediums. I was
            still finding who I was at the time. I simply found it difficult to
            make art for myself, to express my own vision and feelings if it
            wasn't disguised through art I had done for others, but I was
            learning.
          </p>
        </div>
        <div className="break-inside-avoid h-auto w-full max-w-lg p-2 rounded-lg bg-neutral-900 mb-2">
          ...
          <p className="text-neutral-400 text-sm mb-6">
            ...
            resell the shirts on online platforms like Grailed and Mercari. At
            the time, I went over to Yeeev's crib to get some help to shoot the
